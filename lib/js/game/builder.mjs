 ...
 * @file Load and build json levels made with tiled-mapeditor
 * using a specific format to turn the 2D map 3D
 */
...
/**
 * @function
 * Load all tileset URLs from a tiledmap-JSON file to actual
 * images in the "tilesets" attribute
 */
...
/**
 * @function
 * Adds the "vox" and "flat" categories to a JSON
 */
...
/**
 * @function
 * Adds the "mesh" category to the JSON
 */
